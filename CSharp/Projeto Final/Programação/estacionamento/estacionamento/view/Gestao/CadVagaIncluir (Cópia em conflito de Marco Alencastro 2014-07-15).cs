...
namespace Estacionamento.View.Gestao
{
    public partial class CadVagaIncluir : Form
    {
        ...
        public CadVagaIncluir()
        {
            ...
            quantidade_de_vagas = vg.quantidade_vaga;
            andares = vg.andar;
        ...
        private void CadVagaIncluir_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            //MessageBox.Show(((Math.Ceiling((double)(quant / 4))) + 1).ToString());
            //for (int j = 0; j < ((Math.Ceiling((double)(quant / 4))) + 1); j++)
            //{
                //posicao_y = 12;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            gerVaga.painel_da_vaga(quantidade_de_vagas, andares + " - " + quantidade_de_vagas, 10, 10, painelVaga, andares);

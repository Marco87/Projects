...
namespace Estacionamento.View.Gestao
{
    public partial class AlterarVaga : Form
    {
        ...
        {
            gerVaga.painel_da_vaga_alterar(quantidade_de_vagas, andares +" - "+ quantidade_de_vagas, "DISPONÍVEL", 10, 10, 0, painelVaga, andares);
        ...
        {
            comboBoxEstadoVaga.Items.Clear();
            comboBoxEstadoVaga.Text = "";
            gerVaga.preencher_combobox(comboBoxEstadoVaga, quantidade_de_vagas);
        }

        private void buEstadoVaga_Click(object sender, EventArgs e)
        {
            if (comboBoxEstadoVaga.Text.Trim() == "" || comboBoxEstadoVaga2.Text.Trim() == "")
            {
                MessageBox.Show("Escolha uma Opção!");
            }
            else
            {
                gerVaga.mudar_estado_alterar(comboBoxEstadoVaga, comboBoxEstadoVaga2, quantidade_de_vagas);
                comboBoxEstadoVaga.Text = "";
            }
        }

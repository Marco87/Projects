...
CREATE TABLE `dependente` (
  ...
  CONSTRAINT `idTitular` FOREIGN KEY (`idDependente`) REFERENCES `cliente` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `dependente` VALUES (1,12,'JOSE JUNIOR','(  )     -','(  )      -','','');
